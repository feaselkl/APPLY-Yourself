/* Example 3:  get latest/greatest child record */
...
/*
--Add a helpful index
CREATE INDEX [IX_SalesOrderHeader_CustomerID_SalesOrderID_n_PurchaseOrderNumber_OrderDate] ON Sales.SalesOrderHeader
(
	CustomerID,
	SalesOrderID DESC
)
...
*/
/*
DROP INDEX [IX_SalesOrderHeader_CustomerID_SalesOrderID_n_PurchaseOrderNumber_OrderDate] ON Sales.SalesOrderHeader;
*/
